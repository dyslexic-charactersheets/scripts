...
// exportFolderAsPDF(new Folder(sourceFolder+'Starfinder'), new Folder(destinationFolder+'starfinder'));
...
exportFolderAsPDF(new Folder(sourceFolder+'Languages/Italian/Starfinder'), new Folder(destinationFolder+'languages/italian/starfinder'));
...
exportFolderAsPDF(new Folder(sourceFolder+'Languages/Spanish/Starfinder'), new Folder(destinationFolder+'languages/spanish/starfinder'));
...
exportFolderAsPDF(new Folder(sourceFolder+'Languages/Polish/Starfinder'), new Folder(destinationFolder+'languages/polish/starfinder'));
...
exportFolderAsPDF(new Folder(sourceFolder+'Languages/Portuguese/Starfinder'), new Folder(destinationFolder+'languages/portuguese/starfinder'));
...
// exportFolderAsPDF(new Folder(sourceFolder+'Languages/Brazilian Portuguese/Pathfinder'), new Folder(destinationFolder+'languages/brazilian-portuguese/pathfinder'));
// exportFolderAsPDF(new Folder(sourceFolder+'Languages/Brazilian Portuguese/3.5'), new Folder(destinationFolder+'languages/brazilian-portuguese/dnd35'));
exportFolderAsPDF(new Folder(sourceFolder+'Languages/Brazilian Portuguese/Starfinder'), new Folder(destinationFolder+'languages/brazilian-portuguese/starfinder'));
// exportFolderAsPDF(new Folder(sourceFolder+'Languages/Brazilian Portuguese/All'), new Folder(destinationFolder+'languages/brazilian-portuguese/pathfinder'));
// exportFolderAsPDF(new Folder(sourceFolder+'Languages/Brazilian Portuguese/All'), new Folder(destinationFolder+'languages/brazilian-portuguese/dnd35'));
...
exportFolderAsPDF(new Folder(sourceFolder+'Languages/French/Starfinder'), new Folder(destinationFolder+'languages/french/starfinder'));
...
exportFolderAsPDF(new Folder(sourceFolder+'Languages/German/Starfinder'), new Folder(destinationFolder+'languages/german/starfinder'));
...
exportFolderAsPDF(new Folder(sourceFolder+'Languages/Russian/Starfinder'), new Folder(destinationFolder+'languages/russian/starfinder'));
...
// exportFolderAsPDF(new Folder(sourceFolder+'Languages/Norwegian/Starfinder'), new Folder(destinationFolder+'languages/norwegian/starfinder'));
...
// exportFolderAsPDF(new Folder(sourceFolder+'Languages/Dutch/Starfinder'), new Folder(destinationFolder+'languages/dutch/starfinder'));
...
// exportFolderAsPDF(new Folder(sourceFolder+'Languages/US English/Starfinder'), new Folder(destinationFolder+'languages/american/starfinder'));
